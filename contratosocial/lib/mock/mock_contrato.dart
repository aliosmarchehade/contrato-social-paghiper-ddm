...
//   DTOClausulas(id: 1, titulo: "Falecimento", descricao: "Em caso de falecimento de sócio, suas quotas serão transmitidas aos herdeiros legais.", contratoSocialId: 1),
//   DTOClausulas(id: 2, titulo: "Saída de Sócio", descricao: "O sócio poderá se retirar da sociedade mediante aviso prévio de 60 dias.", contratoSocialId: 1),
//   DTOClausulas(id: 3, titulo: "Dissolução", descricao: "A sociedade poderá ser dissolvida por decisão unânime dos sócios.", contratoSocialId: 1),
// ];
...
final List<DTOEmpresa> mockEmpresas = [
  DTOEmpresa(
    id: 1,
    nomeEmpresarial: "Tech Solutions LTDA",
    cnpj: "12.345.678/0001-99",
    enderecoId: 1,
    objetoSocial: "Desenvolvimento de softwares e consultoria em TI",
    duracaoSociedade: "Prazo indeterminado",
  ),
];
...
final List<DTOCapitalSocial> mockCapitalSocial = [
  DTOCapitalSocial(
    ...
    prazoIntegralizacao: "Integralizado na constituição",
  ),
];
...
final List<DTODuracaoExercicioSocial> mockDuracaoExercicio = [
  DTODuracaoExercicioSocial(
    ...
    dataFim: DateTime.parse("2023-12-31"),
  ),
];
...
final List<DTOClausulas> mockClausulas = [
  DTOClausulas(
    id: 1,
    titulo: "Falecimento",
    descricao: "Em caso de falecimento de sócio, suas quotas serão transmitidas aos herdeiros legais.",
    contratoSocialId: 1,
  ),
  DTOClausulas(
    id: 2,
    titulo: "Saída de Sócio",
    descricao: "O sócio poderá se retirar da sociedade mediante aviso prévio de 60 dias.",
    contratoSocialId: 1,
  ),
  DTOClausulas(
    id: 3,
    titulo: "Dissolução",
    descricao: "A sociedade poderá ser dissolvida por decisão unânime dos sócios.",
    contratoSocialId: 1,
  ),
];
